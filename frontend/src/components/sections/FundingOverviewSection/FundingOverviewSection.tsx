  ...
  return (
    <div className='w-full flex justify-center text-center lg:text-left'>
      <div className="flex flex-col lg:flex-row w-full max-w-300 gap-4 sm:gap-5 md:gap-6 lg:gap-6">
        {/* LEFT CONTAINER */}
        <div className='flex-1 min-h-194 sm:min-h-184 md:min-h-188 lg:min-h-194 flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 p-5 sm:p-6 md:p-8 lg:p-10 rounded-[10px] border-2 border-white/10'>
          {/* TOP SECTION */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mt-2">
            {infoCards.map((card, idx) => (
              ...
              >
                ...
                {/* Bottom part */}
                <div className='flex flex-col sm:flex-row sm:items-end gap-1.5 sm:gap-2.5 md:gap-3 lg:gap-3'>
                  {card.variant === "amount" ? (
                    <>
                      <span className='font-inter font-semibold text-[1rem] sm:text-[1.125rem] md:text-[1.25rem] lg:text-[1.5rem] text-white'>
                        ${card.value}
                      </span>
                      <span className='font-poppins font-normal text-[0.875rem] sm:text-[0.90625rem] md:text-[0.921rem] lg:text-[0.9375rem] text-(--color-grey)'>
          ...
          <div className='flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 mt-4'>
            <span className='font-inter font-semibold text-[1.125rem] sm:text-[1.25rem] md:text-[1.375rem] lg:text-[1.5rem] text-white leading-[1.9rem] sm:leading-8 md:leading-8.5 lg:leading-9'>
              Fund Allocation
            </span>
            <div className='flex flex-col gap-3 sm:gap-4 md:gap-4.5 lg:gap-5'>
